...
public class DeploymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barcodeView = findViewById(R.id.deployment_barcode_scanner);
        ...
        barcodeView.decodeContinuous(new BarcodeCallback() {
            ...
            public void barcodeResult(BarcodeResult result) {
                ...
                if (scannedData.contains("n°serie") && scannedData.contains("Longueur") && scannedData.contains("Largeur") && scannedData.contains("Date")) {
                    ...
                    Toast.makeText(DeploymentActivity.this, "Format de QR Code invalide", Toast.LENGTH_SHORT).show();
    ...
    // Fonction pour envoyer les données à l'API de déploiement
    private void sendDataToServer(String matricule) {
        String url = "https://levirtuoz.alwaysdata.net/recuperation/deploy_bache.php";  // URL de la deuxième API
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if ("success".equals(status)) {
                                Toast.makeText(DeploymentActivity.this, "Statut déployé mis à jour avec succès", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(DeploymentActivity.this, "Erreur lors de la mise à jour", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Toast.makeText(DeploymentActivity.this, "Erreur JSON: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DeploymentActivity.this, "Erreur réseau: " + error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
